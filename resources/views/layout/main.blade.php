...
<head>
    ...
    <meta name="description" content="madina transit transport logistique manutention est une société de transit et de transport qui s'occupe de toute activité de manutention
                    portuaire et aéroportuaire avec un professionalisme hors du commun ,Madina Transit Transport
                    Logistique votre Partenaire pour  toutes vos opérations Douanières Terre Air Mer au Sénégal">
...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="{{route('home')}}">Madina Transit</a>
        </div>
            ...
            <div class="parallax-content">
                <div class="row wow fadeInLeft">
                    ...
                    <div class="col-md-3">
                        <div class="funfacts text-center">
                            <div class="icon">
                                <a href="https://plus.google.com/112385653035580310910?hl=fr"><i class="fa fa-google"></i></a>
                            </div>
                            <h4>Google</h4>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <div class="regularform">
                    ...
                    <form action="{{ route('contact') }}"  method="post" class="text-left">
                        <input name="nom" type="text" class="col-md-6 norightborder" placeholder="Votre Nom *" required>
                        <input name="email" type="email" class="col-md-6" placeholder="Votre adresse mail  *" required>
                        <textarea name="contenus" class="col-md-12" placeholder="Message *" required></textarea>
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                        <input type="submit" class="contact submit btn btn-primary btn-xl" value="Envoyer">
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                  <a href="{{ route('adminhome') }}" > &copy; 2017 powered by WeMadeItin </a>
                </p>
            </div>
        </div>
    </div>
